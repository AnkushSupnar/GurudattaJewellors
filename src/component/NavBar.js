...
class NavBar extends Component {
    render() {
        return (
            <Navbar bg="success" expand="lg" variant="dark" className="bg-success text-white">
                <Navbar.Brand href="">Gurudatta Jewellers </Navbar.Brand>
                <Navbar.Toggle aria-controls="basic-navbar-nav" />
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        <NavLink activeClassName="active_class" to="/dashboard/billing" className="nav-link">Daily Billing</NavLink>
